...
from district.soviet_street.house1 import  room2 as inhabitants_6
from district.soviet_street.house2 import  room1 as inhabitants_7
from district.soviet_street.house2 import  room2 as inhabitants_8
...
print('На районе живут: ', ' , '.join(inhabitants_1.folks), ' , '.join(inhabitants_2.folks), ' , '
    ...
    inhabitants_3.folks), ' , '.join(inhabitants_4.folks), ' , '.join(inhabitants_5.folks), ' , '
                                                                                            ''.join(
    inhabitants_6.folks), ' , '.join(inhabitants_7.folks), ' , '.join(inhabitants_8.folks), sep='\n')
